...
5. Population pyramid (20 points).
    ...
    ```{r}
 plot5data <- Data %>% group_by(h_age_dv, sex_dv) %>% count(h_age_dv) 
 plot5data <- na.omit(plot5data)

    
  plot5<-ggplot(plot5data, aes(y = n, x = h_age_dv, fill = sex_dv)) + 
  geom_bar(data = subset(plot5data, sex_dv == "female"), stat = "identity")+
      geom_bar(data = subset(plot5data, sex_dv == "male"), stat = "identity")+
